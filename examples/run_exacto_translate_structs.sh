...
exacto translate-structs \
  ...
  --num-threads 2 \
  --output-tsv-file outputs/translate-structs/rna-100-tumor_minimap2_mdtagged_sorted_exacto_primary_structures.tsv \
  --output-fasta-file outputs/translate-structs/rna-100-tumor_minimap2_mdtagged_sorted_exacto_primary_structures.fasta
