...
def test_call_case_specific_dna_variants_8():
    df_variants = identify_case_specific_dna_variants(
        case_bam_file=get_data_path(name='bam/dna-008-tumor_minimap2_mdtagged_sorted.bam'),
        case_bam_bai_file=get_data_path(name='bam/dna-008-tumor_minimap2_mdtagged_sorted.bam.bai'),
...
def test_call_case_specific_dna_variants_9():
    df_variants = identify_case_specific_dna_variants(
        case_bam_file=get_data_path(name='bam/dna-009-tumor_minimap2_mdtagged_sorted.bam'),
        case_bam_bai_file=get_data_path(name='bam/dna-009-tumor_minimap2_mdtagged_sorted.bam.bai'),
...
def test_call_case_specific_dna_variants_10():
    df_variants = identify_case_specific_dna_variants(
        case_bam_file=get_data_path(name='bam/dna-010-tumor_minimap2_mdtagged_sorted.bam'),
        case_bam_bai_file=get_data_path(name='bam/dna-010-tumor_minimap2_mdtagged_sorted.bam.bai'),
...
def test_call_case_specific_dna_variants_11():
    df_variants = identify_case_specific_dna_variants(
        case_bam_file=get_data_path(name='bam/dna-011-tumor_minimap2_mdtagged_sorted.bam'),
        case_bam_bai_file=get_data_path(name='bam/dna-011-tumor_minimap2_mdtagged_sorted.bam.bai'),
