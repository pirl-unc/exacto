...
from exacto.utilities.vcf_utils import convert_pbsv_vcf_to_dataframe
from exacto.constants import *
from exacto.default_parameters import *


def test_refine_dna_structural_variants_pbsv():
    # Step 1. Load data
    ...
    output_tsv_file = get_data_path('hg002_pbsv_refined.tsv')
