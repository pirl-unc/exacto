...
def test_annotate_dna_structural_variants_ensembl_pbsv():
    # Step 1. Load data
    ...
    assert 'protein_coding' in df_sv_pbsv_annotated['ensembl_pos_1_gene_type'].values.tolist(), \
        "The value 'protein_coding' is expected to appear in the column 'ensembl_pos_1_gene_type'"
    assert 'PRKCZ' in df_sv_pbsv_annotated['ensembl_pos_1_gene_name'].values.tolist(), \
