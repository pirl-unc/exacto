...
from exacto.variants.merging.structural_variants import *
from exacto.default_parameters import *


def test_merge_dna_structural_variants():
    # Step 1. Load data
    annotated_sniffles2_tsv_file = get_data_path(name='hg002_sniffles2_annotated_ensembl.tsv')
    annotated_pbsv_tsv_file = get_data_path(name='hg002_pbsv_annotated_ensembl.tsv')
    annotated_cutesv_tsv_file = get_data_path(name='hg002_cutesv_annotated_ensembl.tsv')
    annotated_svim_tsv_file = get_data_path(name='hg002_svim_annotated_ensembl.tsv')
    ...
    output_tsv_file = get_data_path('hg002_structural_variants_merged_deduped_ensembl.tsv')
