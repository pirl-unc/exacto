...
pub struct AssembledTranscriptIntron {
    ...
    pub exon_5p_flank_read_position: u32,       // Read position immediately before the intron starts (towards 5')
    pub exon_3p_flank_read_position: u32        // Read position immediately after the intron ends (towards 3')
}

impl PartialEq for AssembledTranscriptIntron {
...
impl Eq for AssembledTranscriptIntron {}

impl Hash for AssembledTranscriptIntron {
...
impl AssembledTranscriptIntron {
    pub fn new(
...
impl Clone for AssembledTranscriptIntron {
    fn clone(&self) -> Self {
        AssembledTranscriptIntron {
