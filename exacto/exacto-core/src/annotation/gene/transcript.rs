...
impl Transcript {
    ...
    pub fn get_exon_by_number(&self, exon_number: u16) -> Option<&Exon> {
    ...
    pub fn vectorize_exons(
        ...
        let v_size: u32 = end - start + 1;
        let mut v: Vec<i8> = vec![unaligned_value; v_size as usize];
        for exon in self.exons.values() {
