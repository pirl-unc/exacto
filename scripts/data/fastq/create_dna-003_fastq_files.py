...
if __name__ == "__main__":
    ...
    # Step 3. Create a somatic deletion (7674201-7674230)
    reference_position_1 = 7674201
    reference_position_2 = 7674230
    ...
    create_fastq_file(
        ...
        output_fastq_file='../../../test/data/fastq/dna-003-tumor_long-read.fastq',
        num_reads=[3,3]
    )
    create_fastq_file(
        sequences=[sequence_normal],
        output_fastq_file='../../../test/data/fastq/dna-003-normal_long-read.fastq',
        num_reads=[3]
    )
    ...
    pd.DataFrame(data).to_csv('../../../test/data/tsv/ground_truth/dna-003-tumor_ground_truth.tsv', sep='\t', index=False)
    pd.DataFrame(data).to_csv('/Users/leework/Documents/Research/projects/project_exacto/exacto/exacto/exacto-caller/src/tests/data/tsv/ground_truth/dna-003-tumor_ground_truth.tsv', sep='\t', index=False)
