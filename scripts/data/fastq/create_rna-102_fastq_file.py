...
if __name__ == "__main__":
    ...
    # Step 3. Fetch TP53 sequence and create a somatic deletion (chr17:7673751-7673760)
    ...
    for _,row in df_exons_tp53.iterrows():
        ...
        if exon_number == 8:
            # Create a deletion (7673751-7673760)
            reference_position_1 = 7673751
            reference_position_2 = 7673760
            ...
            tumor_sequence = normal_sequence[:local_position_1] + normal_sequence[local_position_2+1:]
        else:
    ...
    create_fastq_file(
        ...
        output_fastq_file='../../../test/data/fastq/rna-102-tumor_long-read.fastq',
        num_reads=[1,1],
        stranded=True
    )
    ...
    pd.DataFrame(data).to_csv('../../../test/data/tsv/ground_truth/rna-102-tumor_ground_truth.tsv', sep='\t', index=False)
    pd.DataFrame(data).to_csv('/Users/leework/Documents/Research/projects/project_exacto/exacto/exacto/exacto-caller/src/tests/data/tsv/ground_truth/rna-102-tumor_ground_truth.tsv', sep='\t', index=False)
