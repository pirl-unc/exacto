...
and run Exacto 'annotate-vars' command.
"""
...
def add_cli_annotate_vars_arg_parser(sub_parsers) -> argparse._SubParsersAction:
    """
    Add 'annotate-vars' parser.
    ...
    parser_optional.add_argument(
        ...
        dest="num_threads",
        type=int,
        default=ANNOTATE_VARS_NUM_THREADS,
        required=False,
...
def run_cli_annotate_vars_from_parsed_args(args):
    """
    Run Exacto 'annotate-vars' command using parameters from parsed arguments.
