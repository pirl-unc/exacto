...
and run Exacto 'translate' command.
"""
...
def add_cli_translate_vars_arg_parser(sub_parsers) -> argparse._SubParsersAction:
    """
    Add 'translate' parser.
    ...
    Returns:
        sub_parsers     :   argparse.ArgumentParser subparsers
    """
    parser = sub_parsers.add_parser('translate', help='Translate transcript sequences in a long-read RNA-seq FASTQ file to peptide sequences.')
