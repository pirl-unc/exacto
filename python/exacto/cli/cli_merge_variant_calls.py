...
and run Exacto 'merge-variant-calls' command.
"""
...
def add_cli_merge_variant_calls_arg_parser(sub_parsers) -> argparse._SubParsersAction:
    """
    Adds 'merge-variant-calls' parser.
    ...
    """
    parser = sub_parsers.add_parser('merge-variant-calls', help='Merge variant (Exacto) TSV files.')
    ...
    parser_required.add_argument(
        ...
        help="Variants list TSV file. "
             "This TSV file must have been generated by Exacto for this command to work properly."
    )
    parser_required.add_argument(
        "--output-tsv-file",
