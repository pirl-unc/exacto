...
and run Exacto 'vcf2tsv' command.
"""
...
def add_cli_vcf2tsv_arg_parser(sub_parsers) -> argparse._SubParsersAction:
    """
    Add 'vcf2tsv' parser.
...
def run_cli_vcf2tsv_from_parsed_args(args) -> None:
    """
    Run Exacto 'vcf2tsv' command using parameters from parsed arguments.
