...
and run Exacto 'simulate_variants' command.
"""
...
def add_exacto_simulate_variants_arg_parser(sub_parsers):
    """
    Adds 'simulate' parser.
    ...
    """
    parser = sub_parsers.add_parser('simulate_variants', help='Simulate variants.')
...
def run_exacto_simulate_variants_from_parsed_args(args):
    """
    Run Exacto 'simulate_variants' command using parameters from parsed arguments.
