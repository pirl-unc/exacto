...
and run Exacto 'annotate-variants' command.
"""
...
def add_cli_annotate_variants_arg_parser(sub_parsers) -> argparse._SubParsersAction:
    """
    Adds 'annotate-variants' parser.
    ...
    parser_required.add_argument(
        ...
        type=str,
        required=True,
        help="Input variants TSV file (generated by Exacto)."
    )
    parser_required.add_argument(
        "--annotation-source",
    ...
    parser.set_defaults(which='annotate-variants')
    return sub_parsers


def run_cli_annotate_variants_from_parsed_args(args) -> None:
    """
    Run Exacto 'annotate-variants' command using parameters from parsed arguments.
