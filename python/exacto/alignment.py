...
"""
The purpose of this python3 script is to implement the Alignment dataclass.
"""
...
from .constants import VariantTypes, VariantCallingMethods, NucleicAcidTypes
...
class Alignment:
    ...
    def call_variants(self, num_processes: int) -> pd.DataFrame:
        ...
        if self.nucleic_acid_type == NucleicAcidTypes.RNA:
            worker_fn = Alignment.call_rna_variants_worker
